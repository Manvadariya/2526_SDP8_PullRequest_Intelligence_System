...
export default function Footer() {
    return (
        <footer className="bg-ink-400 text-white">
            <div className="mx-auto max-w-7xl px-6 lg:mx-[7.44rem] pt-16 pb-8">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h3 className="text-[0.789rem] font-semibold text-gray-6 uppercase tracking-wider">
                                {category}
                            </h3>
                            <ul className="mt-4 space-y-3">
                                {links.map((link) => (
                                    <li key={link.label}>
                                        <a
                                            href={link.href}
                                            className="text-[0.789rem] text-gray-8 hover:text-white transition-colors"
                                        >
                                            {link.label}
                                        </a>
                                    </li>

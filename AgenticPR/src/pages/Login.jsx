...
export default function Login() {
  ...
  const { loginWithGitHub, loginWithBitbucket, isAuthenticated } = useAuth();
      ...
      <div className="box-border caret-transparent max-w-[420px] outline-transparent w-full mx-auto px-6">
        ...
        <div className="box-border caret-transparent outline-transparent text-center mb-10">
          ...
          <p className="text-neutral-400 text-[15px] box-border caret-transparent tracking-[-0.165px] outline-transparent">
            Sign in to your AgenticPR account
          </p>
        </div>

        {/* GitHub OAuth Button */}
        <div className="box-border caret-transparent outline-transparent mb-3">
          <button
            type="button"
            onClick={loginWithGitHub}
            className="relative text-stone-50 text-[13px] font-[510] items-center bg-zinc-800 box-border caret-transparent gap-x-2 flex shrink-0 h-10 justify-center leading-8 max-w-full outline-transparent gap-y-2 text-nowrap w-full border border-zinc-700 px-3 rounded-lg border-solid hover:bg-zinc-700 transition-colors"
          >
        ...
        <div className="box-border caret-transparent outline-transparent mb-6">
          <button
            ...
            className="relative text-stone-50 text-[13px] font-[510] items-center bg-[#0052CC] box-border caret-transparent gap-x-2 flex shrink-0 h-10 justify-center leading-8 max-w-full outline-transparent gap-y-2 text-nowrap w-full border border-[#0065FF] px-3 rounded-lg border-solid hover:bg-[#0065FF] transition-colors"
          >
            <svg className="shrink-0 h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <form className="box-border caret-transparent outline-transparent" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="box-border caret-transparent outline-transparent mb-2">
            <label className="text-slate-300 text-[13px] font-[510] box-border caret-transparent block tracking-[-0.13px] leading-[19.5px] outline-transparent mb-2">
              Password
            </label>
            <input
          ...
          <div className="box-border caret-transparent outline-transparent text-right mb-6">
            <a href="#" className="text-neutral-400 text-[13px] box-border caret-transparent tracking-[-0.13px] leading-[19.5px] outline-transparent hover:text-stone-50">
              Forgot password?
            </a>
          </div>
        ...
        <div className="box-border caret-transparent outline-transparent text-center mt-8">
          <span className="text-neutral-400 text-[13px] box-border caret-transparent tracking-[-0.13px] leading-[19.5px] outline-transparent">
            ...
            <Link to="/signup" className="text-stone-50 font-[510] box-border caret-transparent outline-transparent hover:text-indigo-400">
              Sign up
            </Link>
          </span>
        </div>
